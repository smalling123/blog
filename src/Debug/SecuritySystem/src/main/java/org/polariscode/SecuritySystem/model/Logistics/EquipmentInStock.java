...
@Component
public class EquipmentInStock implements Serializable {
	@Autowired
	private DictionaryService dictionaryService;

	private static EquipmentInStock m_EquipmentInStock;

	@PostConstruct 
	public void init(){
		m_EquipmentInStock=this;
		m_EquipmentInStock.dictionaryService=this.dictionaryService;
	}
	...
	public String getOrgId_Convert(){
		OrgId_Convert = m_EquipmentInStock.dictionaryService.convertDictionary("Org", String.valueOf(OrgId));
	...
	public String getSiteId_Convert(){
		SiteId_Convert = m_EquipmentInStock.dictionaryService.convertDictionary("Site", String.valueOf(SiteId));
