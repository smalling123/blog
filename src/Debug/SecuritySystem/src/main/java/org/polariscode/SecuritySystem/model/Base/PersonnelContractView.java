...
@Component
public class PersonnelContractView implements Serializable {
	@Autowired
	private DictionaryService dictionaryService;

	private static PersonnelContractView m_PersonnelContractView;

	@PostConstruct 
	public void init(){
		m_PersonnelContractView=this;
		m_PersonnelContractView.dictionaryService=this.dictionaryService;
	}
	...
	public String getPersonnelID_Convert(){
		PersonnelID_Convert = m_PersonnelContractView.dictionaryService.convertDictionary("Personnel", String.valueOf(PersonnelID));
	...
	public String getCompanyId_Convert(){
		CompanyId_Convert = m_PersonnelContractView.dictionaryService.convertDictionary("Company", String.valueOf(CompanyId));
